 ...
 */
public class Combine<T> implements JoinAccumulation<T, T, T, T, T, List<Set<T>>, List<List<T>>>
{
  ...
  @Override
  public List<Set<T>> accumulate3(List<Set<T>> accumulatedValue, T input)
  {
    return accumulateWithIndex(2, accumulatedValue, input);
  }

  @Override
  public List<Set<T>> accumulate4(List<Set<T>> accumulatedValue, T input)
  {
    return accumulateWithIndex(3, accumulatedValue, input);
  }

  @Override
  public List<Set<T>> accumulate5(List<Set<T>> accumulatedValue, T input)
  {
