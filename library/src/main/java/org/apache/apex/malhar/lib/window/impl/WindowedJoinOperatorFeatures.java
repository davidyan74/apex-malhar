...
/**
 * This class provides the features in a JoinWindowedOperator and is intended to be used only
 * by the implementation of such operator
 */
abstract class WindowedJoinOperatorFeatures<InputT1, InputT2, AccumT, AccumulationT extends JoinAccumulation, DataStorageT extends WindowedStorage>
{
  ...
  protected WindowedJoinOperatorFeatures()
  {
    // for kryo
  }

  WindowedJoinOperatorFeatures(AbstractWindowedOperator<InputT1, ?, DataStorageT, ?, AccumulationT> operator)
  {
  ...
  /**
   * The join features for plain (non-keyed) operator
   */
  static class Plain<InputT1, InputT2, AccumT, AccumulationT extends JoinAccumulation<InputT1, InputT2, AccumT, ?>, DataStorageT extends WindowedStorage.WindowedPlainStorage<AccumT>>
      extends WindowedJoinOperatorFeatures<InputT1, InputT2, AccumT, AccumulationT, DataStorageT>
  {
    private Plain()
    {
      // for kryo
  ...
  /**
   * The join features for keyed operator
   */
  static class Keyed<KeyT, InputT1, InputT2, AccumT, AccumulationT extends JoinAccumulation<InputT1, InputT2, AccumT, ?>, DataStorageT extends WindowedStorage.WindowedKeyedStorage<KeyT, AccumT>>
      extends WindowedJoinOperatorFeatures<KeyValPair<KeyT, InputT1>, KeyValPair<KeyT, InputT2>, AccumT, AccumulationT, DataStorageT>
  {
    private Keyed()
    {
      // for kryo
