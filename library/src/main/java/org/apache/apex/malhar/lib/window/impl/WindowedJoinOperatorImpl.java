...
/**
 * WindowedJoinOperatorImpl
 */
public class WindowedJoinOperatorImpl<InputT1, InputT2, AccumT, OutputT>
    extends AbstractWindowedJoinOperator<InputT1, InputT2, OutputT, WindowedStorage.WindowedPlainStorage<AccumT>, WindowedStorage.WindowedPlainStorage<OutputT>, JoinAccumulation<InputT1, InputT2, ?, ?, ?, AccumT, OutputT>>
{
  @Override
  public void accumulateTuple2(Tuple.WindowedTuple<InputT2> tuple)
  {
    for (Window window : tuple.getWindows()) {
      ...
      dataStorage.put(window, accumulation.accumulate2(accum, tuple.getValue()));
    }
  }
  ...
  public void fireNormalTrigger(Window window, boolean fireOnlyUpdatedPanes)
  {
    ...
    System.out.println("accu : " + accumulatedValue);
