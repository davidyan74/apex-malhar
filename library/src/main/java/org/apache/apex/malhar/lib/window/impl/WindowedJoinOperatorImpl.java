...
public class WindowedJoinOperatorImpl<InputT1, InputT2, AccumT, OutputT>
    extends WindowedOperatorImpl<InputT1, AccumT, OutputT> implements JoinWindowedOperator<InputT1, InputT2>
{
  private Function<InputT2, Long> timestampExtractor2;

  private WindowedJoinOperatorFeatures.Plain joinFeatures = new WindowedJoinOperatorFeatures.Plain(this);
